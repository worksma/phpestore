<li>
	<div class="input-group mb-2">
		...
		<input id="cname_{id}" type="text" class="form-control" placeholder="Наименование" value="{name}">
		<input id="cpos_{id}" type="number" min="1" class="form-control" placeholder="Позиция" value="{position}">
	</div>
</li>