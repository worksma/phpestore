...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "../public/addons/toasty/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: "../public/addons/toasty/sounds/success/1.mp3",
            // path to sound for warn message:
            warning: "../public/addons/toasty/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "../public/addons/toasty/sounds/error/1.mp3",
        },
